      ...
      <TopContainer>
        ...
        <div className="leftHeading">
          ...
          <div>
            ...
            <div className="head2">
              Continue by signing in using your facebook account
            </div>
            {/* <GoogleLogin
              clientId="clientid"
            ...
            /> */}
            <GoogleLoginComponent auth={props.auth} />
          </div>
        </div>
      </TopContainer>
      <BottomContainer>
        <div className="rightHeading">
          ...
          <div>
            ...
            <div className="righthead2">
              With our geolocation feature you can find the people around you
            </div>
            <div></div>
          </div>
        </div>
